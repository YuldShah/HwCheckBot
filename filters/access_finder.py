...
class IsAdminCallback(BaseFilter):
    async def __call__(self, callback: CallbackQuery) -> bool:
        return callback.from_user.id in config.ADMINS and callback.inline_message_id or callback.message.chat.type == "private"
...
class IsUserCallback(BaseFilter):
    async def __call__(self, callback: CallbackQuery) -> bool:
        ...
        return res and callback.inline_message_id or callback.message.chat.type == "private"
